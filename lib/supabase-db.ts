...
import { getRuntimeEnvVar } from './runtime-env'
...
export function getSupabaseClient() {
  if (!supabaseClient) {
    ...
    let supabaseUrl = getRuntimeEnvVar('NEXT_PUBLIC_SUPABASE_URL')
    let supabaseServiceKey = getRuntimeEnvVar('SUPABASE_SERVICE_ROLE_KEY')
