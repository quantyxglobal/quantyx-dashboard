...
import { User, Users, Settings, LogOut, ChevronDown, Building2 } from 'lucide-react'
...
export function UserDropdown({ userName, userRole = 'Client User', firmInfo }: UserDropdownProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        {/* User Avatar */}
        <div className="flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-primary to-primary-glow shadow-glow">
          ...
          <div className="absolute right-0 top-full mt-2 w-64 bg-card/95 backdrop-blur-md border border-border/50 rounded-xl shadow-elegant z-50 overflow-hidden">
            ...
            <div className="px-4 py-3 border-b border-border/50 bg-gradient-to-r from-primary/5 to-accent/5">
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-primary to-primary-glow shadow-glow">
            ...
            <div className="py-2">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Invite colleagues</p>
                </div>
              </Link>
