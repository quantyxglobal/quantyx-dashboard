...
export default async function SuperAdminCaseDetailPage({
  params,
}: {
  ...
  try {
    ...
    console.error('[SUPERADMIN_CASE] Error fetching additional uploads:', error)
  ...
  try {
    ...
    console.error('[SUPERADMIN_CASE] Error fetching case assignments:', error)
